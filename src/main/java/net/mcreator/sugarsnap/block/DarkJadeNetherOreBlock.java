...
public class DarkJadeNetherOreBlock extends SugarsnapModElements.ModElement {
	@ObjectHolder("sugarsnap:dark_jade_nether_ore")
	public static final Block block = null;

	public DarkJadeNetherOreBlock(SugarsnapModElements instance) {
		super(instance, 15);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sugarsnap:dark_jade_nether_ore_match"),
